            ...
            if check_command:
                ...
                try:
                    ...
                    if proc_result.returncode == 0:
                        ...
                        result.message = self._extract_error_message(proc_result.stderr or proc_result.stdout)
                        result.details = self._extract_error_details(proc_result.stderr or proc_result.stdout)
                    ...
                    result.status = 'failed'
                    result.message = f"Check timed out after 30 seconds"
