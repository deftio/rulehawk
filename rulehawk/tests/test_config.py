...
"""
    ...
    def test_merge_configs(self):
        ...
        base = {
            "ai_provider": "none",
            "logging": {"dir": "rulehawk_data", "format": "jsonl"},
            "enabled_rules": "all",
        }
        override = {
            "ai_provider": "claude",
        ...
        self.assertEqual(merged["logging"]["dir"], "rulehawk_data")  # Preserved
    ...
    def test_environment_overrides(self):
        ...
        config = {"ai_provider": "none", "logging": {"dir": "rulehawk_data", "format": "jsonl"}}
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            try:
                ...
                with patch.object(ConfigLoader, "_load_file", return_value={"ai_provider": "test"}):
                    # Create a fake rulehawk.yaml file
                    Path("rulehawk.yaml").touch()
                    config = ConfigLoader.load()
