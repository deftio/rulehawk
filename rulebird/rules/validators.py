    ...
    try:
        ...
        if current_branch in protected_branches:
            return {
                ...
                'details': [
                    f"Switch to a feature branch before making changes",
                    f"Use: git checkout -b feature/your-feature-name"
                ]
            }

        return {
            'success': True,
            'message': f"On feature branch: {current_branch}"
        }
    except Exception as e:
        return {
            'success': False,
            'message': f"Could not determine current branch: {str(e)}"
        }
...
def check_task_plan(config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        'success': True,
        'message': "Task plan exists and is complete"
    }
...
def check_task_plan_updated(config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        'success': True,
        'message': "Task plan recently updated"
    }
...
def check_ci_status(config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    ci_configured = any(
        (project_root / ci_file).exists() if not ci_file.startswith('.github')
    ...
    return {
        'success': True,
        'message': "CI checks passing (or not configured)"
    }
